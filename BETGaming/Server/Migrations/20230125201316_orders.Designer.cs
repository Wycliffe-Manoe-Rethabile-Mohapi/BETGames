...
namespace BETGaming.Server.Migrations
{
    ...
    [Migration("20230125201316_orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BETGaming.Shared.CartItem", b =>
                {
                    ...
                    b.HasKey("UserId", "ProductId", "ProductypeId");
            ...
            modelBuilder.Entity("BETGaming.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BETGaming.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("BETGaming.Shared.OrderItem", b =>
                {
                    b.HasOne("BETGaming.Shared.Order", "Order")
                        .WithMany("OrderItems")
