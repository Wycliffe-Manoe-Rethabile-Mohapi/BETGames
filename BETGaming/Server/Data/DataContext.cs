            ...
            modelBuilder.Entity<Product>().HasData
                (
                    new Product()
                    {
                        ...
                        new Product { Id = 16, Title = "The Last of Us Part II", Description = "The highly-anticipated sequel to the critically-acclaimed game.", ImageURL = "", Price = 59.99m, CategoryId = 1 },
                        new Product { Id = 17, Title = "Cyberpunk 2077", Description = "An open-world RPG set in a futuristic metropolis.", ImageURL = "", Price = 59.99m, CategoryId = 1 },
                        new Product { Id = 18, Title = "Horizon Zero Dawn", Description = "An action RPG set in a post-apocalyptic world ruled by robotic creatures.", ImageURL = "", Price = 49.99m, CategoryId = 1 },
                        new Product { Id = 19, Title = "Red Dead Redemption 2", Description = "An epic tale of life in America's unforgiving heartland.", ImageURL = "", Price = 59.99m, CategoryId = 1 },
                        new Product { Id = 20, Title = "The Witcher 3: Wild Hunt", Description = "An open-world action RPG based on the bestselling fantasy series.", ImageURL = "", Price = 49.99m, CategoryId = 1 },
                        new Product { Id = 21, Title = "Death Stranding", Description = "An action game developed by Hideo Kojima, creator of the Metal Gear series.", ImageURL = "", Price = 59.99m, CategoryId = 1 },
                        new Product { Id = 22, Title = "The Legend of Zelda: Breath of the Wild", Description = "An open-air adventure game set in a vast wilderness.", ImageURL = "", Price = 59.99m, CategoryId = 1 },
                        new Product { Id = 23, Title = "Super Mario Odyssey", Description = "A 3D platformer featuring Mario's first sandbox-style gameplay.", ImageURL = "", Price = 59.99m, CategoryId = 1 },
                        new Product { Id = 24, Title = "Persona 5", Description = "A role-playing game that follows a group of high school students.", ImageURL = "", Price = 49.99m, CategoryId = 1 },
                        new Product { Id = 25, Title = "Final Fantasy VII Remake", Description = "A modern retelling of the classic RPG.", ImageURL = "", Price = 59.99m, CategoryId = 1 },
                        new Product { Id = 26, Title = "Monster Hunter: World", Description = "A game where players take on the role of a hunter and slay different monsters", ImageURL = "", Price = 49.99m, CategoryId = 1 },
                        new Product { Id = 27, Title = "Overwatch", Description = "A team-based first-person shooter game developed by Blizzard Entertainment.", ImageURL = "", Price = 39.99m , CategoryId = 1 },
                        //...
                        new Product { Id = 28, Title = "Minecraft", Description = "A sandbox game where players can build and explore virtual worlds.", ImageURL = "", Price = 19.99m , CategoryId = 1 }
